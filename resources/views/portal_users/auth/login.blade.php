        ...
        <div class="container-login100">
            <div class="wrap-login100">
                <div class="login100-pic js-tilt" data-tilt>
                    <img src="{{asset('dashboard/images/login.jpg')}}" alt="IMG"  width="300px">
                </div>
                {{-- {{ route('staff.login.submit') }} --}}
                <form class="login100-form" method="POST" action="">
                    @csrf
                    <input type="hidden" name="type" value="staff">
                    <span class="login100-form-title text-success font-weight-bold">
                    ...
                    <div class="container-login100-form-btn">
                        <a href="{{url('user/forget/password')}}" class="pb-2 font-weight-bolder text-success">
                            <i class="fa fa-lock"></i>
                            Forget Password
                            <i class="fa fa-question"></i>
                        </a>
                        <button class="login100-form-btn text-capitalize">
