...
@section('content')
    ...
    <div class="container">
        <form action="{{action('PermissionSystemController@role_store')}}" method="post" class="mb-5" id="store_role">
            @csrf
            <div class="form-row mb-sm-2 ">
                <div class="col-md-12">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="role" class="form-control @error('role') is-invalid @enderror" placeholder="Enter role name" value="{{old('role')}}">
                        {{-- @error('role')
                    ...
                    @foreach ($permissions as $key=>$value)
                        <div class="col-md-4 col-12 mt-2">
                            <div class="custom-control custom-control-inline custom-checkbox">
                                <input type="checkbox"  name="permissions[]" id="permission{{$key+1}}" class="custom-control-input @error('permissions') is-invalid @enderror" value="{{$value->id}}">
